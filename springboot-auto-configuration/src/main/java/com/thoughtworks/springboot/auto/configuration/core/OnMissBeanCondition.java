...
public class OnMissBeanCondition implements SpringBootLoadFilter, ConfigurationCondition {
    ...
    public void match(ConfigurableListableBeanFactory beanFactory, List<String> autoConfigurationClasses) {
        ...
        while (classIterator.hasNext()) {
            ...
            // 拿到配置的条件
            final List<String> beans = AutoConfigurationConditionLoader.getCondition(autoConfigurationClass, "OnMissBean");
    ...
    public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
        Map<String, Object> annotationAttributes = metadata.getAnnotationAttributes(ConditionalOnMissBean.class.getName());
